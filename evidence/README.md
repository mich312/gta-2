...
| `ring-fence-ends.png` | The Old Quarter's east side, where the ring road's twin carriageways cut the 20° grid. Every street on both sides stops two tiles short of the ring: the limited-access shave of §14.3 D6, kept on purpose. These are the largest class left in the dead-end census (PROGRESS.md) and the picture is here so the decision can be argued with. Retake: `--crop=628,205,70 --scale=8`. |
